...
namespace Maliev.CurrencyService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260110154147_AddBatchStatus")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Maliev.CurrencyService.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.CurrencyService.Domain.Entities.BatchStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.CurrencyService.Domain.Entities.CountryCurrency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.CurrencyService.Domain.Entities.Currency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.CurrencyService.Domain.Entities.ExchangeRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.CurrencyService.Domain.Entities.RateSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.CurrencyService.Domain.Entities.StagedSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.CurrencyService.Domain.Entities.CountryCurrency", b =>
                {
                    b.HasOne("Maliev.CurrencyService.Domain.Entities.Currency", "Currency")
                        .WithMany()
